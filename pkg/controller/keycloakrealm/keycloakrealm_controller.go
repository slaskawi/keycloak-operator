...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &keycloakv1alpha1.KeycloakRealm{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner KeycloakRealm
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &keycloakv1alpha1.KeycloakRealm{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileKeycloakRealm) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set KeycloakRealm instance as the owner and controller
...
func newPodForCR(cr *keycloakv1alpha1.KeycloakRealm) *corev1.Pod {
